...
import { CREATE_PROJECT_POST } from 'graphql/mutations/create';
...
const CreateProject = ({ goBack }) => {
    ...
    const [create, { data, error }] = useMutation(CREATE_PROJECT_POST)
    ...
    const handleSubmit = async (e) => {
        ...
        if (mediaImagePresets && utilitiesPresets && masterPlanPresets) {
            create({
                variables: {
                    data: {
                        ...formData,
